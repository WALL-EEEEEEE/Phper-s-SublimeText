...
"D:\WindowsSoftWare\php53\php.exe" -d auto_append_file="" -d auto_prepend_file="" -d include_path="D:\\WindowsSoftWare\\php53" -f "D:\\WindowsSoftWare\\phpcs_requires\\phpcs.phar" -- %*
